...
from metrics.metrics import ConfusionMatrix, DetMetrics, box_iou
...
class DetectionValidator(BaseValidator):
    ...
    def __init__(self, dataloader=None, save_dir=None, pbar=None, args=None, _callbacks=None):
        ...
        self.args = args
        super().__init__(dataloader, save_dir, pbar, _callbacks)
        self.is_coco = False
        self.class_map = None
    ...
    def print_results(self):
        ...
        if self.nt_per_class.sum() == 0:
            LOGGER.warning(
                f'WARNING  no labels found in the set, can not compute metrics without labels')
